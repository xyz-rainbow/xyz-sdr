...
- **Cobertura**: `--cov=core --cov=setup --cov=tui` en CI; umbral actual `--cov-fail-under=45` (subida gradual desde 40; los siguientes PRs deberían subirlo a 50/55 cubriendo `tui/app.py`, `python_runtime.py`, `setup/check_env.py`).
